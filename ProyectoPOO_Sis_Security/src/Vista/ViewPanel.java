...
public class ViewPanel extends JFrame{
    ...
    public JTextField inputUsr, inputPass; // Inputs (usuario y contraseña)
    ...
    // Atributos para pestaña 2 (Gestion Usuarios)
    private final JPanel pGestionUSR;  // Pestaña 2
    ...
    // Atributos para pestaña 3 (Gestión permisos)
    private JPanel pGestionPerm; // Pestaña para gestion de permisos
    
    private JPanel panRegisPerm;
    private JLabel[] etiqRegisPerm; // Etiquetas para el registro
    private JTextField[] inputRegisPerm;
    public JButton otorgarPerm;
    public JButton denegarPerm;
    
    private JPanel panAulas;
    private JScrollPane scrollAulas;
    private JTable reportAulas;
    public DefaultTableModel modelReportAulas; // Modificable desde controlador

    private JPanel panRoles;
    private JScrollPane scrollRoles;
    private JTable reportRoles;
    public DefaultTableModel modelReportRoles; // Modificable desde controlador
    
    private JPanel panReportPerm;
    private JScrollPane scrollPerm;
    private JTable reportPerm;
    ...
    private JLabel[] etiqBusqReportPerm;
    ...
    public ViewPanel(){
        ...
        nextOptions = new JButton("Avanzar ->"   );
        ...
        searchCode  = new JButton("Buscar codigo" );
        searchUsr   = new JButton("Buscar usuario");
        prevOptions = new JButton("<- Retroceder" );
        ...
        String[] inputCamposPerm = {"Cod Aula","Cod Rol"};
        ...
        String[] etiquetasFiltroReport = {"Filtrar por","Valor"};
